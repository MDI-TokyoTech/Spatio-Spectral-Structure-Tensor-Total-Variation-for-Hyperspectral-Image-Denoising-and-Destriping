...
Y1 = zeros([n1, n2, n3, 2, blocksize(1), blocksize(2)], 'single');
Y2 = zeros([n1, n2, n3], 'single');
...
gamma1_U    = single(1./(prod(blocksize) * 2*2 * 2 + 1));
gamma1_S    = single(1);
gamma1_T    = single(1/(2 + 1));
gamma2_Y1   = single(1/(2*2));
gamma2_Y2   = single(1/3);
gamma2_Y3   = single(1/2);
